...
This github project contains the code for the [Athens Municipatily](http://go.scify.gr/cityrus-web) website, that enables city administrators to define missions and citizens to view their contributions.
You can find the related service [here](http://go.scify.gr/cityrus-service)
and the mobile application [here](https://play.google.com/store/apps/details?id=gr.scify.cityrus)
