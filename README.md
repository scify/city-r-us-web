...
This github project contains the code for the [Athens Municipatily](http://go.scify.gr/cityrus-web) website, that enables city administrators to define missions and citizens to view their contributions.<br/>
